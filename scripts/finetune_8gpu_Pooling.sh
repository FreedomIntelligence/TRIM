...
/mntcephfs/lab_data/songdingjie/mllm/LLaVA/model/models--openai--clip-vit-large-patch14-336/snapshots/ce19dc912ca5cd21c8a653c79e251e808ccabcd1
################## Training Config ################
...
# area: 256 144 64 36
for reduce_func_param in 144 256 64 36; do
experiment_name=llava-${MODEL_VERSION}-only-finetune-${reduce_func}_${pooling_func}_beforeMLP_K${reduce_func_param}
export WANDB_NAME="only-finetune-${reduce_func}_${pooling_func}_beforeMLP_K${reduce_func_param}"
...
deepspeed llava/train/train_mem.py \
    ...
    --mm_vision_token_reduce_func ${reduce_func}:${pooling_func}-${reduce_func_param} \
