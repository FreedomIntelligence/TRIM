...
mlp_adapter_path="model/llava-v1.5-7b"
...
export WANDB_NAME="only-finetune-${reduce_func}_beforeMLP_T${reduce_func_param}_Lora"

    # --model_name_or_path /mntcephfs/data/med/xidong/ckpt/llava-lang \
